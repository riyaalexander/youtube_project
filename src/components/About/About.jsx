    ...
    <div className="text-wrapper">
      ...
      <div className="about-us">
        ...
        <article className="bio">
          ...
          <div className="bio">
            <p>
              As a graduate of John Jay College of Criminal Justice and a student in the Pursuit Fellowship for software development, I am committed to staying at the forefront of the rapidly evolving tech industry. I believe that knowledge is key to
              success in this field, and I am dedicated to constantly expanding my skills and staying up-to-date with the latest developments.
            </p>
            <p>
              Although my background is mainly in music and the arts, I have found a passion for coding and software development. With experience in teaching the arts and working as a security officer at a Northwell Hospital, I have developed skills
              in communication, collaboration, and problem-solving that I believe are essential to success as a developer.
            </p>
            <p>
              My current focus is on front-end development, and I am fluent in JavaScript, HTML, and CSS. Additionally, I am currently learning React and exploring new technologies to enhance my skills and stay up-to-date with the latest developments
              in the field.
            </p>
            <p>
        ...
        <article className="bio">
          ...
          <div className="bio">
            ...
            <p>
              Originally from Lima, Peru and now based in Brooklyn, NY, I am proud to be part of a global community of software engineers who are dedicated to innovation and excellence. I am inspired by the power of technology to simplify people's
              lives and make the world a better place.
            </p>
            <p>
              My passion for programming is fueled by my love of learning and my commitment to staying at the forefront of the rapidly evolving tech industry. Whether I am working on a new project or exploring the latest developments in the field, I
              am always eager to expand my skills and improve my abilities.
            </p>
            <p>
        ...
        <article className="bio">
          ...
          <div className="bio">
            ...
            <p>
              Whether you are looking for a program for family event planning, workshops to promote personal growth, or any other project that promotes familial bonding and positive communication, I am here to help. Thank you for considering me for
              your next project. Let's work together to create software that makes a difference in people's lives!
            </p>
          </div>
        </article>
      </div>
